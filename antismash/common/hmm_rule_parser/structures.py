...
class DynamicProfile(Signature):
    ...
    def __init__(self, name: str, description: str,
                 detect: Callable[[Record, Dict[str, List[ProfileHit]]], Dict[str, List[DynamicHit]]]) -> None:
        super().__init__(name, "dynamic", description, 0, __file__)
        self._callable = detect

    def find_hits(self, record: Record, hmmer_hits: Dict[str, List[ProfileHit]]) -> Dict[str, List[DynamicHit]]:
