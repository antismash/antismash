    ...
    def build_location(self) -> Location:
        ...
        if self.circular_origin and self.start > self.end:
            return CompoundLocation([
                FeatureLocation(self.start, self.circular_origin),
                FeatureLocation(0, self.end),
            ])
...
class ProtoclusterAnnotation:
    ...
    def build_core_location(self) -> Location:
        ...
        if self.circular_origin and self.core_start > self.core_end:
            return CompoundLocation([
                FeatureLocation(self.core_start, self.circular_origin),
                FeatureLocation(0, self.core_end),
            ])
